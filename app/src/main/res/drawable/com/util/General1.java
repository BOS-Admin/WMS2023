...
import com.hc.mixthebluetooth.CustomListDialog;
import com.hc.mixthebluetooth.storage.CustomListDialog1;
...
public class General1 {
    private static volatile General1 instance = null;
   ...
   public String AppVersion = "App Version 2.2.29 25/1/2024";
    ...
    public static ArrayList<String> DialogData;
    public static String dialogTitle;
    public static void ShowDialog(FragmentManager fragmentManager, String Title, ArrayList<String> Data){
        DialogData=Data;
        dialogTitle=Title;
    ...
    public static void ShowDialog1(FragmentManager fragmentManager, String Title, ArrayList<String> Data){
        DialogData=Data;
        dialogTitle=Title;
        CustomListDialog1 dialog=new CustomListDialog1();
        dialog.show(fragmentManager,"");
    }
    ...
    public static General1 getGeneral(Context ctx) {
        if (instance == null) {
            synchronized(General1.class) {
                if (instance == null) {
                    instance = new General1();
    ...
    public void onSaveInstanceState(Bundle state) {
        ...
        state.putBoolean("IsAdmin",IsAdmin);
    }
