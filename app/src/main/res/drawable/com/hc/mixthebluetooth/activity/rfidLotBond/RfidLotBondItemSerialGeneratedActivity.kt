...
open class RfidLotBondItemSerialGeneratedActivity : BasActivity(), RFIDListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lotBondTimeBetweenItems = Integer.parseInt(mStorage!!.getDataString("LotBondTimeBetweenItems", "2000"))
                ...
                api.postRidLotBondSession(session)
                    ...
                    .subscribe(
                        { s ->
                            ...
                            addSuccessStep("Waiting for current item to pass",
    ...
    open fun setTitle() {
        setTitle("Rfid Lot Bond Generate ItemSerial")
    }
    ...
    fun setPopWindow(v: View) {
        PopWindowMain(
            v, this@RfidLotBondItemSerialGeneratedActivity
        ) { resetEngine ->
            //弹出窗口销毁的回调
