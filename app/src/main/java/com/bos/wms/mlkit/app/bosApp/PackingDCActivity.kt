...
class PackingDCActivity : AppCompatActivity() {
    ...
    fun ValidateScan(ItemSerial:String) {
        ...
        try {
            ...
            compositeDisposable.addAll(
                api.ValidateFillBinItem(itemCode,general.mainLocation,general.UserID,general.packReasonId)
    ...
    private fun proceed() {
        ...
        try {
            ...
            var model=
                FillBinDCModel (textBoxNb.text.toString(),general.UserID,modelItems,PackingTypeId,general.destination,locationId)
