...
import kotlinx.android.synthetic.main.activity_shipment_pallete_carton_count.*
...
class ShipmentCartonCountReceivingActivity : AppCompatActivity() {
    //Our variables
   ...
   // private lateinit var btnDone : Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_shipment_pallete_carton_count)
       ...
       // }
        TextChangeEvent=object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                var NbofCartonsStr:String=txtShipCartonReciNbofCartons.text.toString()
                ...
                when (seqVal) {
                    ...
                    1 -> {
                        ...
                        txtShipCartonReciNbofCartons.setText("")
                        txtShipCartonReciBolNb.requestFocus()
                        UpdatingText=false;
                    }
                    2 -> {
                    ...
                    3 -> {
                        txtShipCartonReciNbofCartons.setText("")
                        txtShipCartonReciNbofCartons.requestFocus()
                        UpdatingText=false;
                    }
                    4 -> {
                ...
                txtShipCartonReciNbofCartons.setShowSoftInputOnFocus(false);
            }
        ...
        txtShipCartonReciNbofCartons.addTextChangedListener(TextChangeEvent);
        txtShipCartonReciBolNb.requestFocus()
    ...
    fun PostShipmentReceivingCarton(BolNumber: String, PalleteNb:Int, NbofCartons:Int, ForceInsert:Int){
        try {
            ...
            compositeDisposable.addAll(
                api.ShipmentReceivingCartonCount(UserID,BolNumber, PalleteNb, NbofCartons,ForceInsert)
                                ...
                                if(ErrorMsg.startsWith("Success:")){
                                 ...
                                 //   UploadTrial=0
                                   // uploadBitmap(UploadBitmap, UploadPath)
                                    ...
                                    if(ErrorMsg.startsWith("Mismatch")){
                                        AlertDialog.Builder(this)
                                            .setIcon(android.R.drawable.ic_dialog_alert)
                                            .setTitle("Mismatch Number of Cartons")
                                            .setMessage("Number of cartons " +NbofCartons.toString()+" not matched with the expected, Are you sure you want to proceed?")
                                            .setPositiveButton("Yes",
                                                DialogInterface.OnClickListener { dialog, which ->
                                                    PostShipmentReceivingCarton(BolNumber, PalleteNb, NbofCartons, 1)
                                                })
    ...
    var ValidatedBols:ArrayList<Int> = arrayListOf()
    fun ValidateAppointmentBol(AppointmentNo: Int,BolNo: Int) {

        try {
            // TODO: handle loggedInUser authentication
            if(ValidatedBols.contains(BolNo)){
                BolValidated=true;
    ...
    private fun UploadImage(filePath:File) {
            ...
            if (filePath != null) {
                ...
                Toast.makeText(
                    this@ShipmentCartonCountReceivingActivity, "no image selected",
                    Toast.LENGTH_LONG
                ).show()
            }
        }
