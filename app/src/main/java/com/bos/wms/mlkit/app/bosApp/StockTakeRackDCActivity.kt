...
import Model.BosApp.StockTake.FillRackStockTakeDCModelItem
...
class StockTakeRackDCActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (stockTakeType) {
            101 -> lblBox.text = "Stand"
            100 -> lblBox.text = "Box"
            102 -> lblBox.text = "Rack"
            else -> lblBox.text = "Invalid"
        }
    ...
    fun ValidateScan(itemCode:String) {
        ...
        try {
            ...
            compositeDisposable.addAll(
                api.ValidateStockTakeItemForRack(itemCode)
    ...
    private fun proceed() {
        ...
        try {
            ...
            var modelItems: ArrayList<FillRackStockTakeDCModelItem> = arrayListOf()
            for (it in items)
                modelItems.add(FillRackStockTakeDCModelItem(it.value))

            var model =
                FillRackStockTakeDCModel(
