...
public final class ActivityUpcpricingOverrideBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ConstraintLayout upcPricingOverrideActivityLayout;

  private ActivityUpcpricingOverrideBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView txtStandId, @NonNull ConstraintLayout upcPricingOverrideActivityLayout) {
    ...
    this.upcPricingOverrideActivityLayout = upcPricingOverrideActivityLayout;
  }
  ...
  @NonNull
  public static ActivityUpcpricingOverrideBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUpcpricingOverrideBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_upcpricing_override, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUpcpricingOverrideBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout upcPricingOverrideActivityLayout = (ConstraintLayout) rootView;

      return new ActivityUpcpricingOverrideBinding((ConstraintLayout) rootView, clipBoardBtn,
          confirmBtn, constraintLayout, guideline, horizontalGuideLineTwo, insertBarcode,
          lblItemSerial, lblUPC, scannedItemSerial, scannedItemUPC, scannedItemsListView,
          txtStandId, upcPricingOverrideActivityLayout);
    }
