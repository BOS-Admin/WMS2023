...
public final class ActivityUpcrecognitionPricingBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout upcCameraLayout;

  @NonNull
  public final ConstraintLayout upcPricingActivityLayout;

  private ActivityUpcrecognitionPricingBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView txtStandId, @NonNull LinearLayout upcCameraLayout,
    ...
    this.upcCameraLayout = upcCameraLayout;
  ...
  @NonNull
  public static ActivityUpcrecognitionPricingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUpcrecognitionPricingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_upcrecognition_pricing, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUpcrecognitionPricingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.upcCameraLayout;
      LinearLayout upcCameraLayout = ViewBindings.findChildViewById(rootView, id);
      if (upcCameraLayout == null) {
        break missingId;
      }

      ConstraintLayout upcPricingActivityLayout = (ConstraintLayout) rootView;

      return new ActivityUpcrecognitionPricingBinding((ConstraintLayout) rootView, cameraPreview,
          cameraPreviewImageView, clipBoardBtn, confirmBtn, constraintLayout, guideline,
          horizontalGuideLineTwo, insertBarcode, lblItemSerial, lblUPC, scannedItemSerial,
          scannedItemUPC, scannedItemsListView, txtStandId, upcCameraLayout,
