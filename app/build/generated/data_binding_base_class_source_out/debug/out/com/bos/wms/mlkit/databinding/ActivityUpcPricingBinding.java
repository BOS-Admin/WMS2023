...
public final class ActivityUpcPricingBinding implements ViewBinding {
  ...
  private ActivityUpcPricingBinding(@NonNull CoordinatorLayout rootView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityUpcPricingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUpcPricingBinding((CoordinatorLayout) rootView, toolbar);
    }
