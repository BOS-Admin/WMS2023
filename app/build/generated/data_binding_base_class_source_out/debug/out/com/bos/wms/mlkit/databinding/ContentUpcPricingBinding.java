...
public final class ContentUpcPricingBinding implements ViewBinding {
  @NonNull
  ...
  private ContentUpcPricingBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView UPCPricingListView, @NonNull Button btnUPCPricingDone,
      @NonNull TextView lblError, @NonNull TextView lblItemSerial, @NonNull TextView lblUPC,
      @NonNull LinearLayout linearLayout, @NonNull RecyclerView recyclerView,
      @NonNull TextView textView, @NonNull EditText txtItemSerial, @NonNull EditText txtUPC) {
  ...
  @NonNull
  public static ContentUpcPricingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ContentUpcPricingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.content_upc_pricing, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ContentUpcPricingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentUpcPricingBinding((ConstraintLayout) rootView, UPCPricingListView,
          btnUPCPricingDone, lblError, lblItemSerial, lblUPC, linearLayout, recyclerView, textView,
          txtItemSerial, txtUPC);
    }
